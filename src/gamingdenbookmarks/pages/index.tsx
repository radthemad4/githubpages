...
createRoot(<>
  ...
  <div className='Content'>
    ...
    <div>See also:
      <ul>
        <li><a href="https://dnd-wiki.org/wiki/Tome_Material">Tome Material in dnd-wiki</a>, as well as <a href="https://dnd-wiki.org/wiki/3.5e_Homebrew">other 3.5e material there</a>. However, ads are terrible on dnd-wiki, so make sure you have an adblocker (I recommend <a href="https://github.com/gorhill/uBlock">uBlock origin</a>). Also, you can <a href="https://gist.github.com/radthemad4/472c676a0609b5f127645d35508efa5a">use this with a custom CSS addon</a> (e.g. <a href="https://add0n.com/stylus.html">Stylus</a>) or <a href="https://gist.github.com/radthemad4/7a6ef11d9ac97b26b8e92b5ad3590a05">this script</a> with a  Userscript Manager (e.g. <a href="https://docs.scriptcat.org/en/">ScriptCat</a>, <a href="https://violentmonkey.github.io/">ViolentMonkey</a> or <a href="https://addons.mozilla.org/en-US/firefox/addon/firemonkey/">FireMonkey</a>) to reduce the size of the sidebar and topbar there.</li>

...
export const koumeiMonsterPrcs: PrestigeClassEntry[] = [
    ...
    ...[
        ...
        ...[
            {
                name: 'Erinyes Recruitment Specialist',
        ...
        {
            name: 'Drider PrC: Blood Seeker',
            link: 'https://www.tgdmb.com/phpBB3/viewtopic.php?p=575160#p575160',
            minimumStartingLevel: 9,
        },
        {
            name: 'Ravid PrC: Animator',
            link: 'https://www.tgdmb.com/phpBB3/viewtopic.php?p=578434#p578434',
            minimumStartingLevel: 6,
        },
        {
            name: 'Lilitu PrC: Abyssal Sponsor',

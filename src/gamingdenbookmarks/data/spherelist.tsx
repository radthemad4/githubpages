...
export const spheres: Entry[] = [
    ...
    }),
    {
        name: 'Time',
        author: 'PhaedrusXY',
        link: 'https://tgdmb.com/phpBB3/viewtopic.php?p=139550#p139550'
    },
    ...[
        {
            name: 'Permafrost',
        ...
        return {
            name: element.name,
            author: 'IGTN',
            link: 'https://tgdmb.com/phpBB3/viewtopic.php?p=165845#p165845',
            wikiLink: element.wikiLink
        }
    }),
    {
        name: 'Lies',
        author: 'Hicks',
        link: 'https://tgdmb.com/phpBB3/viewtopic.php?t=50458'
    },
    {
        name: 'Truth',
        author: 'koz',
        link: 'https://tgdmb.com/phpBB3/viewtopic.php?p=122972#p122972'
    },
    ...['Cheating', 'Snake', 'Stealing'].map((name) => {
        return {
            name,
            author: 'koz',
            link: 'https://www.tgdmb.com/phpBB3/viewtopic.php?p=123198#p123198',
        }
    }),
    {
        name: 'Teleportation',
        author: 'Hicks',
        link: 'https://tgdmb.com/phpBB3/viewtopic.php?p=534091#p534091'
    },
    {
        name: 'Life',
        author: 'Hicks',
        link: 'https://tgdmb.com/phpBB3/viewtopic.php?p=543812#p543812'
    },
    {
        name: 'Badgers',
        author: 'Rejakor',
        link: 'https://www.tgdmb.com/phpBB3/viewtopic.php?p=100914#p100914'
    },
    ...['Trickery', 'Aegis'].map((name) => {
        return {
            name,
            author: 'Akula',
            link: 'https://www.tgdmb.com/phpBB3/viewtopic.php?p=100982#p100982',
        }
    }),
    {
        name: 'Ravenous Butterfly',
        author: 'Murtak',
        link: 'https://www.tgdmb.com/phpBB3/viewtopic.php?p=101119#p101119'
    },
    {
        name: 'Aegis',
    ...
    },
    {
        name: 'Eye',
        author: 'Avoraciopoctules',
        link: 'https://www.tgdmb.com/phpBB3/viewtopic.php?p=113068#p113068'
    },
    ...['Valor', 'Peace'].map((name) => {
        return {
            name,
            author: 'Avoraciopoctules',
            link: 'https://www.tgdmb.com/phpBB3/viewtopic.php?p=144258#p144258',
        }
    }),
    ...['Virtue', 'Purification'].map((name) => {
        return {
            name,
            author: 'Avoraciopoctules',
            link: 'https://www.tgdmb.com/phpBB3/viewtopic.php?p=144336#p144336',
        }
    }),
    {
        name: 'Tempest',
        author: 'Avoraciopoctules',
        link: 'https://www.tgdmb.com/phpBB3/viewtopic.php?p=144494#p144494'
    },
    {
        name: 'Crusader',
        author: 'For Valor',
        link: 'https://www.tgdmb.com/phpBB3/viewtopic.php?p=144808#p144808'
    },
    {
        name: 'Prototype',
        author: 'Prak',
        link: 'https://www.tgdmb.com/phpBB3/viewtopic.php?p=182473#p182473'
    },
    ...['Spider', 'Web'].map((name) => {
        return {
            name,
    ...
    },
    {
        name: 'Psionics',
        author: 'Quantumboost',
        link: 'https://tgdmb.com/phpBB3/viewtopic.php?p=133024#p133024',
    },
    ...['Majesty', 'Magi',].map((name) => {
        return {
            name,
            author: 'CatharzGodfoot',
            link: 'https://www.tgdmb.com/phpBB3/viewtopic.php?p=90608#p90608',
        }
    }),
    ...['Courage', 'Healing',].map((name) => {
        return {
            name,
            author: 'koz',
            link: 'https://www.tgdmb.com/phpBB3/viewtopic.php?p=90619#p90619',
        }
    }),
    ...[
        ...
        return {
            name,
            author: 'CatharzGodfoot',
            link: 'https://www.tgdmb.com/phpBB3/viewtopic.php?p=90621#p90621',
        }
    }),
    {
        name: 'Judgement',
        author: 'CatharzGodfoot',
        link: 'https://www.tgdmb.com/phpBB3/viewtopic.php?p=90632#p90632',
    },
    {
        name: 'Prayer',
        author: 'koz',
        link: 'https://www.tgdmb.com/phpBB3/viewtopic.php?p=90633#p90633',
    },
    {
        name: 'Black Dragon',
        author: 'Prak',
        link: 'https://www.tgdmb.com/phpBB3/viewtopic.php?p=90648#p90648',
    },
    ...[
        ...
        return {
            name,
            author: 'CatharzGodfoot',
            link: 'https://www.tgdmb.com/phpBB3/viewtopic.php?p=248454#p248454',
        }
    }),
    {
        name: 'Deception',
        author: 'Maxus',
        link: 'https://tgdmb.com/phpBB3/viewtopic.php?p=59910#p59910',
    },
    ...['Earth', 'Stone', 'Metal',].map((name) => {
        return {
            name,
            author: 'Prak',
            link: 'https://tgdmb.com/phpBB3/viewtopic.php?p=158692#p158692',
        }
    }),
    {
        name: 'Wind (Old)',
        author: 'Kaelik',
        link: 'https://www.tgdmb.com/phpBB3/viewtopic.php?p=102602#p102602',
    },
    {
        name: 'Wind',
        author: 'Kaelik',
        link: 'https://www.tgdmb.com/phpBB3/viewtopic.php?p=456186#p456186',
        wikiLink: 'https://dnd-wiki.org/wiki/Wind_(3.5e_Sphere)'
    },
    {
        name: 'Travel',
        author: 'Prak',
        link: 'https://www.tgdmb.com/phpBB3/viewtopic.php?p=442428#p442428',
    },
    {
        name: 'Beastshaper',
        author: 'Prak',
        link: 'https://www.tgdmb.com/phpBB3/viewtopic.php?p=501164#p501164',
    },
    ...['Ash', 'Salt', 'Trickery', 'Unmaking', 'Vapour'].map((name) => {
        return {
            name,
            author: 'Koumei',
            link: 'https://tgdmb.com/phpBB3/viewtopic.php?p=545939#p545939',
        }
    }),
    {
        name: 'Freedom',
        author: 'Avoraciopoctules',
        link: 'https://www.tgdmb.com/phpBB3/viewtopic.php?p=144531#p144531',
    },
    ...['Forest', 'Beast',].map((name) => {
        return {
            name,
            author: 'Hicks',
            link: 'https://www.tgdmb.com/phpBB3/viewtopic.php?p=130327#p130327',
        }
    }),
    {
        name: 'Illusion',
    ...
    ...['Delirium', 'Despair', 'Destiny', 'Destruction'].map((name) => {
        return {
            name,
            author: 'Catharz',
            link: 'https://www.tgdmb.com/phpBB3/viewtopic.php?p=28883#p28883',
        }
    }),
    {
        name: 'Deception',
        author: 'Maxus',
        link: 'https://www.tgdmb.com/phpBB3/viewtopic.php?p=59910#p59910',
    },
    ...['Addiction', 'Substance "Use"',].map((name) => {
        return {
            name,
            author: 'Judging__Eagle',
            link: 'https://www.tgdmb.com/phpBB3/viewtopic.php?p=53866#p53866',
        }
    }),
    {
        name: 'Crow',
    ...
    },
    {
        ...
        author: 'Prak',
        link: 'https://www.tgdmb.com/phpBB3/viewtopic.php?p=32512#p32512',
    },
    {
        name: 'White Dragon',
        author: 'FrankTrollman',
        link: 'https://www.tgdmb.com/phpBB3/viewtopic.php?p=32500#p32500',
    },
    {
        name: 'Machine, The',
        author: 'Prak',
        link: 'https://www.tgdmb.com/phpBB3/viewtopic.php?p=566850#p566850',
    },
    {
        name: 'Drill',
        author: 'Prak',
        link: 'https://www.tgdmb.com/phpBB3/viewtopic.php?p=566871#p566871',
    },
    {
        name: 'Vespa',
        author: 'Prak',
    ...
    },
    {
        name: 'Hive',
        author: 'Prak',
        link: 'https://www.tgdmb.com/phpBB3/viewtopic.php?p=573200#p573200',
    },
    ...[
        ...
        return {
            ...
            link: 'https://tgdmb.com/phpBB3/viewtopic.php?p=540615#p540615',

...
export const acfLists: ACFList[] = (() => {
    let acfLists = [
            ...
            acfs: [
                {
                    ...
                    link: 'https://www.tgdmb.com/phpBB3/viewtopic.php?f=6&t=50170',
                },
            ]
        },
        {
        ...
        },
        {
            ...
            link: 'https://tgdmb.com/phpBB3/viewtopic.php?t=57041',
            acfs: [
                ...['Beast Master', 'Castle Crusher', 'Drunken Rager', 'Lunar Marauder', 'Skald', 'Totemic Sage'].map((name) => {
                    return {
                        name,
                        author: 'Koumei',
                        link: 'https://tgdmb.com/phpBB3/viewtopic.php?p=538228#p538228',
                    }
                }),
                {
                    name: 'Fanatical Pokemaniac',
        ...
        },
        {
            ...
            relatedLinks: [{ name: 'Original', link: 'https://www.tgdmb.com/phpBB3/viewtopic.php?t=24283' }],
            acfs: [
                {
                ...
                ...['Animal Friend', 'Dirge Singer', 'Flame Dancer', 'Sword Dancer',].map((name) => {
                    return {
                        name,
                        author: 'Koumei',
                        link: 'https://tgdmb.com/phpBB3/viewtopic.php?p=539859#p539859',
                    }
                }),
            ]
        },
            ...
            acfs: [
                {
                    ...
                    author: 'Prak',
                    link: 'https://tgdmb.com/phpBB3/viewtopic.php?p=449701#p449701',
                },
            ]
        },
        {
            ...
            acfs: [
                {
                    name: 'Faewyrd',
                    author: 'Prak',
                    link: 'https://tgdmb.com/phpBB3/viewtopic.php?p=447775#p447775',
                },
            ]
        },
        {
            ...
            acfs: [
                ...['Blight', 'Circle', 'Old World', 'Stormcaller', 'Urban', 'Far Realm'].map((name) => {
                    return {
                        name: `${name} Druid`,
                        author: 'Koumei',
                        link: 'https://tgdmb.com/phpBB3/viewtopic.php?p=537994#p537994',
                    }
                }),
                {
                    name: 'Luckbringer Druid',
                    author: 'Sacrificial Lamb',
                    link: 'https://tgdmb.com/phpBB3/viewtopic.php?p=447582#p447582',
                },
                {
                    name: 'Alternative Wildshape',
                    author: 'fbmf',
                    link: 'https://www.tgdmb.com/phpBB3/viewtopic.php?p=130378#p130378',
                },
                {
                    name: 'Alternative Wildshape',
                    author: 'Hicks',
                    link: 'https://www.tgdmb.com/phpBB3/viewtopic.php?p=130513#p130513',
                },
                {
                    name: 'Alternative Wildshape',
                    author: 'Avoraciopoctules',
                    link: 'https://www.tgdmb.com/phpBB3/viewtopic.php?p=130855#p130855',
                },
            ]
        },
        {
            ...
            acfs: [
                {
                    name: 'Sharpshooter',
                    author: 'IGTN',
                    link: 'https://www.tgdmb.com/phpBB3/viewtopic.php?t=50200',
                },
                {
            ...
            acfs: [
                {
                    ...
                    link: 'https://tgdmb.com/phpBB3/viewtopic.php?p=164158#p164158',
                },
                {
                ...
                ...['Elemental Fist', 'Ki Mystic', 'Monk of the Dark Moon', 'Monk of the Long Death', 'Zen Archer',].map((name) => {
                    return {
                        name: `${name}`,
                        author: 'Koumei',
                        link: 'https://tgdmb.com/phpBB3/viewtopic.php?p=539225#p539225',
                    }
                }),
            ]
        },
            ...
            acfs: [
                ...['Cavalier', 'Celestial Crusader', 'Elemental Hero', 'Fist of Righteousness', 'Justiciar', 'Sword Saint'].map((name) => {
                    return {
                        name: `${name}`,
                        author: 'Koumei',
                        link: 'https://tgdmb.com/phpBB3/viewtopic.php?p=540528#p540528',
                    }
                }),
            ]
        },
            ...
            acfs: [
                ...['Belmont', 'Bounty Hunter', 'Dust Guild Initiate', 'Eldritch Scoundrel', 'Shadow Adept'].map((name) => {
                    return {
                        name,
                        author: 'Koumei',
                        link: 'https://tgdmb.com/phpBB3/viewtopic.php?p=545607#p545607',
                    }
                }),
                {
            ...
            acfs: [
                ...
                ...['Daimyo', 'Daisho-Wielder', 'Mind Blade', 'Nature’s Liege', 'Unscrupulous Ronin'].map((name) => {
                    return {
                        name,
                        author: 'Koumei',
                        link: 'https://tgdmb.com/phpBB3/viewtopic.php?p=547264#p547264',
                    }
                }),
                {
                    name: 'Ancestor Summoner',
                    author: 'God_of_Awesome',
                    link: 'https://www.tgdmb.com/phpBB3/viewtopic.php?f=6&t=50940',
                }
            ]
        },
        {
            ...
            acfs: [
                {
                    name: 'Twin-Souled',
                    author: 'Covent',
                    link: 'https://tgdmb.com/phpBB3/viewtopic.php?p=484453#p484453',
                }
            ]
        },
        {
            ...
            relatedLinks: [{ name: 'Revised', link: 'https://www.tgdmb.com/phpBB3/viewtopic.php?t=52419' }],
            acfs: [
                {
            ...
            acfs: [
                {
                    ...
                    author: 'Prak',
                    link: 'https://tgdmb.com/phpBB3/viewtopic.php?p=571346#p571346',
                    relatedLinks: [{ title: 'Pokémaster', link: 'https://dnd-wiki.org/wiki/Pok%C3%A9mon_d20_(3.5e_Sourcebook)/The_Pok%C3%A9master#Pok.C3.A9master_Class' }]
                },
            ]
        },
            ...
            acfs: [
                ...
                ...['Celestial Warlock', 'Axiomatic Warlock', 'Anarchic Warlock', 'Faerie Warlock', 'Warlock of the Stars'].map((name) => {
                    return {
                        name,
                        author: 'Koumei',
                        link: 'https://tgdmb.com/phpBB3/viewtopic.php?p=547603#p547603',
                    }
                }),
            ]
        },
            ...
            acfs: [
                {
                    name: 'Spellsniper',
                    author: 'Prak',
                    link: 'https://www.tgdmb.com/phpBB3/viewtopic.php?p=444881#p444881',
                }
            ]
        },
        {
            ...
            acfs: [
                ...['Focused Specialist', 'Metamagician', 'Temporal Mage', 'War Wizard'].map((name) => {
                    return {
                        name,
                        author: 'Koumei',
                        link: 'https://tgdmb.com/phpBB3/viewtopic.php?p=545834#p545834',
                    }
                }),
            ]
        },

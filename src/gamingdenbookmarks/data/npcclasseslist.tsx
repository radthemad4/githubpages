...
export const npcClasses: Entry[] = [
    ...
    ...['Commoner', 'Expert'].map((element) => {
        return {
            name: element,
            author: 'Koumei',
            link: 'https://tgdmb.com/phpBB3/viewtopic.php?p=165701#p165701',
        }
    }),
    {
        name: 'Aristocrat',
        author: 'Koumei',
        link: 'https://tgdmb.com/phpBB3/viewtopic.php?p=165725#p165725',
    },
    {
        name: 'Verdant Follower',
        author: 'Koumei',
        link: 'https://www.tgdmb.com/phpBB3/viewtopic.php?p=169948#p169948',
    },
    {
        name: 'Commoner',
        author: 'virgil',
    ...
    },
    {
        name: 'Expert',
        author: 'Hicks',
        link: 'https://www.tgdmb.com/phpBB3/viewtopic.php?p=164291#p164291',
    },
    {
        name: 'Berserker',
        author: 'God_of_Awesome',
        link: 'https://www.tgdmb.com/phpBB3/viewtopic.php?f=6&t=50919',
    },
    {
        name: 'Adept',
        author: 'Frank and K',
        link: 'https://www.tgdmb.com/phpBB3/viewtopic.php?p=49292#p49292',
